...
<div class="bg-white shadow-sm rounded-lg p-8">
    ...
    <form id="formData" method="post" action="<?= base_url('admin/students/store'); ?>" class="space-y-4" novalidate>
        <?= csrf_field(); ?>
        ...
        <div class="form-element">
            ...
            <input
                ...
                data-pristine-minlength="3"
                data-pristine-minlength-message="Email must be at leat 3 characters long."
                value="<?= old('email') ?>">
        </div>
